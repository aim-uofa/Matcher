...
class AverageMeter:
    ...
    def __init__(self, dataset):
        ...
        if self.benchmark == 'pascal':
            ...
            self.nclass = 1000
        elif self.benchmark == 'paco_obj':
            self.nclass = 75
        elif self.benchmark == 'paco_part':
            self.nclass = 448 #456
        elif self.benchmark == 'paco_part_box':
            self.nclass = 448 #456
        elif self.benchmark == 'paco_part_box_431cat':
            self.nclass = 448 #431
        elif self.benchmark == 'pascal_part':
            self.nclass = 100
        elif self.benchmark == 'lvis':
            self.nclass = 1203
        elif self.benchmark == 'demo':
            self.nclass = 50
...
class Logger:
    ...
    @classmethod
    def initialize(cls, args, training, root='logs'):
