...
DIST_FILTER=1.8
DECAY_RATIO=25
OUTPUT=output/vos/davis17_multi${MULTIMASK}_filter${SCALE}_filter${DIST_FILTER}_decay_${DECAY_TYPE}${DECAY_RATIO}
if [ ! -d ${OUTPUT} ]; then
    mkdir ${OUTPUT}
fi
...
python /home/yangliu/workspace/pycode/Matcher/v2/matcher_vos/davis2017-evaluation/evaluation_method.py \
  --davis_path /share/project/zxs/datasets/DAVIS17/trainval \
  --set val \
